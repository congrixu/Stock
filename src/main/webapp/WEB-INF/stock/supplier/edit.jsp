...
<body>
	...
	<form class="form-horizontal">
	  ...
	  <div class="form-group">
	    <label for="bank_info" class="col-sm-4 control-label">银行信息：</label>
	    <div class="col-sm-7">
	      <textarea class="form-control" id="bank_info">${requestScope.supplier.bankInfo}</textarea>
	    </div>
	  </div>
	  <div class="form-group">
	    <label for="addr" class="col-sm-4 control-label">地址：</label>
	    <div class="col-sm-7">
	      <textarea  class="form-control" id="addr">${requestScope.supplier.addr}</textarea>
	    </div>
	  </div>
	</form>
</body>
