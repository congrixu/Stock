$(function() {
  ...
  /*
   * columns.push({ field : 'oper', title : '操作', width : 250, formatter : function(value, row, index) { var dom = [];
   * dom.push("<a href='#' id='item_manage' purchaseId='" + row.id + "'>"); dom.push("明细管理"); dom.push("</a>"); return
   * dom.join(""); } });
   */
